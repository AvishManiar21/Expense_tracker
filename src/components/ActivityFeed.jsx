...
function ActivityFeed() {
  ...
  const [activities] = useState([
    ...
    },
    {
      id: 2,
      type: 'settlement',
      description: 'Settled up with John Doe',
      amount: 45.50,
      paidBy: 'You',
    ...
    },
    {
      id: 4,
      type: 'expense_edited',
      description: 'Uber ride - Updated amount',
      amount: 35.00,
      paidBy: 'Jane Smith',
    ...
    },
    {
      ...
      category: 'Food',
      friends: ['Mike Johnson', 'Jane Smith'],
      group: 'Apartment'
    },
    {
      id: 6,
  ...
  const friends = ['John Doe', 'Jane Smith', 'Mike Johnson']
  const groups = ['Apartment', 'Dinner Club', 'Entertainment', 'Transport']
